      ...
      <div className="mx-auto max-w-7xl py-12 px-6 lg:px-8 lg:py-24">
        <div className="space-y-12 lg:grid lg:grid-cols-3 lg:gap-8 lg:space-y-0">
          <div className="space-y-5 sm:space-y-4">
            <h2 className="text-3xl text-orange-600 font-heading tracking-tight sm:text-4xl">
              Our Team
            </h2>
              ...
              {people.map((person) => (
                <li key={person.name}>
                  <div className="space-y-4">
                    ...
                    <div className="space-y-1 text-lg font-medium font-heading leading-6">
                      <h3>{person.name}</h3>
                      <p className="text-orange-600">{person.role}</p>
                    </div>
                    <div className="text-lg">
                      <p className="text-gray-500 font-main">{person.bio}</p>
                    </div>
